...
describe('Notifications', () => {
    test('calling markAsRead triggers console.log with the correct message', () => {
        ...
        const { getAllByRole } = render(<Notifications displayDrawer={true} listNotifications={notificationsArray} />);
        const notificationItem = getAllByRole('listitem');

        fireEvent.click(notificationItem[0]);
